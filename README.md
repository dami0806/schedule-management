...
## 1. 소개
이 프로젝트는 JWT 토큰을 이용한 회원가입, 로그인, JWT 시큐리티 재발급 기능을 포함한 인증 시스템을 구현한 스케줄 관리 API입니다. 스케줄에 대한 CRUD 기능과 댓글 작성, 파일 업로드 기능도 포함되어 있습니다.

## 2. 기능

### 인증 및 인가
- **회원가입**: 사용자가 새로운 계정을 생성할 수 있습니다.
- **로그인**: 사용자가 계정으로 로그인하고 JWT 토큰을 받을 수 있습니다.
- **토큰 재발급**: 만료된 토큰을 재발급받을 수 있습니다.

### 스케줄 관리
- **스케줄 생성**: 새로운 스케줄을 추가할 수 있습니다.
- **스케줄 조회**: 모든 스케줄 목록을 조회할 수 있습니다.
- **스케줄 상세 조회**: 특정 스케줄의 상세 정보를 조회할 수 있습니다.
- **스케줄 수정**: 기존 스케줄의 내용을 수정할 수 있습니다.
- **스케줄 삭제**: 특정 스케줄을 삭제할 수 있습니다.

### 댓글 관리
- **댓글 작성**: 특정 스케줄에 댓글을 작성할 수 있습니다.
- **댓글 수정**: 작성된 댓글을 수정할 수 있습니다.
- **댓글 삭제**: 작성된 댓글을 삭제할 수 있습니다.

### 파일 관리
- **파일 업로드**: 스케줄에 파일을 업로드할 수 있습니다.
- **파일 조회**: 업로드된 파일을 조회할 수 있습니다.
- **파일 삭제**: 업로드된 파일을 삭제할 수 있습니다.
...
## API DOC [링크](https://dami0806.github.io/schedule-management/)
